...
<div class="wrapper">
    ...
    <main>
        <h2>Bevestiging</h2>
        <p>Ben je zeker dat je je product <%= request.getParameter("naam") %> wil verwijderen?</p>
        <form action="Servlet?command=delete&naam=<%= request.getParameter("naam") %>" method="POST">
            <input type="submit" value="Ja"/>
        </form>
        <p><a href="Servlet?command=bestelling">Cancel</a> indien je <%= request.getParameter("naam") %> niet wil verwijderen</p>
    </main>
